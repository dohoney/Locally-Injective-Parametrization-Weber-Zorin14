...
public:
	...
	MeshBuilder( const std::vector<int>* faceIndices, const std::vector<int>* vertexCount = NULL){};
	void operator()(H& hds);
...
//typedef Polyhedron<ExactKernel, PolyhedronItems> MeshExact;
